...
class MixedChartComposer {
  static AAChartModel configureArearangeMixedLineChart() {
    return AAChartModel()
        .titleSet("面积范围均线图")
        .subtitleSet("混合图的一种")
  ...
  static AAChartModel configureColumnrangeMixedLineChart() {
    return AAChartModel()
        .titleSet("城市气温指数")
        .subtitleSet("虚拟数据")
        .yAxisTitleSet("摄氏度")
  ...
  static AAChartModel configureScatterMixedLineChart() {
    return AAChartModel()
  ...
  static AAChartModel configureNegativeColorMixedBubbleChart() {
    return AAChartModel()
  ...
  static AAChartModel configurePolygonMixedScatterChart() {
    return AAChartModel()
        .seriesSet([
      AASeriesElement()
          .nameSet("目标")
  ...
  static AAChartModel configurePolarMixedChart() {
    return AAChartModel()
        .chartTypeSet(AAChartType.column)
        .polarSet(true)
        .seriesSet([
